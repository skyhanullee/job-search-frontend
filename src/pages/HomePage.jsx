...
function HomePage() {
  const { termsQuery, locationQuery } = JSON.parse(window.sessionStorage.getItem("searchDetails") ? window.sessionStorage.getItem("searchDetails") : '{"termsQuery": "", "locationsQuery": "","searchResults": ""}');
